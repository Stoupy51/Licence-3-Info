...
SubShader { 
 ...
 //        d3d11: 159 avg math (142..177), 5 avg texture (3..8), 7 avg branch (6..8)
 Pass {
  Name "FORWARD"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 154 math, 13 temp registers, 5 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
...
//
 ...
 180: sample r1.xyzw, v1.xyxx, t3.xyzw, s4
...
//
 ...
 108: sample_l r9.xyzw, r9.xyzx, t4.xyzw, s0, r2.w
 ...
 133:   endif 
 134:   sample_l r4.xyzw, r6.xyzx, t5.xyzw, s0, r2.w
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 143 math, 13 temp registers, 4 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 4
Set CUBE Texture "unity_SpecCube0" to slot 3 sampler slot 0
...
//
  ...
  92:     mad r4.yzw, r8.xxyz, r6.wwww, r9.xxyz
  93:   endif 
  94:   sample_l r8.xyzw, r4.yzwy, t4.xyzw, s0, r2.w
  95:   add r2.w, r8.w, l(-1.000000)
  96:   mad r2.w, cb2[7].w, r2.w, l(1.000000)
  97:   log r2.w, r2.w
  98:   mul r2.w, r2.w, cb2[7].y
 ...
 168: add r3.xzw, -r0.xxyz, r0.wwww
 169: mad r0.xyz, r3.yyyy, r3.xzwx, r0.xyzx
 170: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 171: sample r1.xyzw, v1.xyxx, t2.xyzw, s4
 172: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
// Approximately 0 instruction slots used
 ...
 // Stats for Fragment shader:
 //        d3d11: 24 avg math (11..38), 4 avg texture (2..6), 1 avg branch (0..2)
 Pass {
  Name "DEFERRED"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 38 math, 5 temp registers, 6 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 37 math, 5 temp registers, 6 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 2
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 3
Set 3D Texture "unity_ProbeVolumeSH" to slot 3 sampler slot 0
...
SubShader { 
 ...
 // Stats for Fragment shader:
 //        d3d11: 110 avg math (54..177), 5 avg texture (4..8), 4 avg branch (2..8)
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="FORWARDBASE" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite [_ZWrite]
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 57 math, 8 temp registers, 5 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_NHxRoughness" to slot 2
...
//
  ...
  69: mad r0.xyz, r2.yzwy, r4.xywx, r0.xyzx
  70: sample r1.xyzw, v1.xyxx, t3.xyzw, s5
  71: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 55 math, 7 temp registers, 5 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_NHxRoughness" to slot 2
Set 2D Texture "_EmissionMap" to slot 3 sampler slot 5
...
//
  ...
  65: mad r0.xyz, r4.zzzz, r4.xywx, r0.xyzx
  66: mul r0.xyz, r0.xyzx, r3.xyzx
  67: mad r0.xyz, r1.xyzx, r2.xyzx, r0.xyzx
  68: sample r1.xyzw, v1.xyxx, t3.xyzw, s5
  69: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
  70: mov o0.w, l(1.000000)
  71: ret 
// Approximately 0 instruction slots used
